...
public class TwoBallAutoLowHangar extends CommandGroup {
    int accelerationSpeed;
    public TwoBallAutoLowHangar() {
        ...
        addSequential(new AutoArcadeEnocderDrive(50, RobotMap.forward, RobotMap.driveFast, 3));// was 42
